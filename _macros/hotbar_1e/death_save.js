    ...
    content: `
      <div class="macro_window">
        <div class="grid grid-2col" style="grid-template-columns: 150px auto">
          <div class="macro_img">
            <img src="systems/cloudempress/images/icons/ui/rolltables/death_save.png" />
          </div>
    ...
    buttons: [
      {
        ...
        callback: () => game.mosh.initRollTable(game.settings.get("cloudempress","table1eDeath"), "1d10 [+]", "low", true, false, null, null),
