...
export class MothershipCreatureSheet extends foundry.appv1.sheets.ActorSheet {
    ...
    static get defaultOptions() {
        var options = {
            ...
            template: "systems/cloudempress/templates/actor/creature-sheet.html",
            width: 820,
            height: 770,
    ...
    activateListeners(html) {
        ...
        html.find('.weapon-roll').click(ev => {
            ...
            if (this.actor.system.swarm && this.actor.system.swarm.enabled){
                ...
                this.actor.rollCheck(null, 'low', weaponStat, null, null, item, swarm_damage_roll_string);
            } else {
                this.actor.rollCheck(null, 'low', weaponStat, null, null, item);
            }
        });
